...
export default function MediaFlowGallery({ items = [] }) {
  ...
  useEffect(() => {
    ...
    const step = (now) => {
      ...
      // when t >= 1, animation stops automatically
    };
  ...
  return (
    <div
      ref={galleryRef}
      className="w-full h-[100vh] overflow-x-auto py-12 rounded-xl mb-10 bg-gradient-to-b from-teal-50 to-transparent dark:from-teal-950 dark:to-transparent">
